import KnowledgeCategory from "../../atoms/news-category/NewsCategory";
...
const KnowledgeCard = ({ title, descripion, time, category, image }: KnowledgeCardProps) => {
  return (
    <div className='mt-5 border border-solid p-2 rounded-xl hover:border-yellow-400 grid grid-cols-12 gap-4 w-[900px] hover:bg-yellow-50'>
      ...
      <div className="col-span-8">
        ...
        <div className="flex gap-4 items-center text-gray-400 mt-3">
          ...
          <div>
            <KnowledgeCategory category_name={category} />
          </div>
        </div>
      </div>
    </div>
